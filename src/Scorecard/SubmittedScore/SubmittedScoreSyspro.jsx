...
import "./SubmittedScoreSyspro.css";
...
const SubmittedScoreSyspro=()=>{
    ...
    return(
        ...
        <div className="row-syspro-grade">
            ...
            <p>Παρακάτω εμφανίζονται οι μαθητές που δήλωσαν το μάθημα <strong style={{color:"purple"}}>Προγραμματισμός Συστήματος</strong></p>
...
export default SubmittedScoreSyspro;