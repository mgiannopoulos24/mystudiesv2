...
const rowsSem5=[
    ...
    createData('Γλωσσική Ανάπτυξη','67ΨΧ34','Ράλλη','Κατ’ Επιλογή Υποχρεωτικό',6,),
    createData('Αρχιτεκτονική Υπολογιστών ΙΙ','Κ30','Γκιζόπουλος','Κατ’ Επιλογή Υποχρεωτικό',6,),
    createData('Τεχνολογίες της Πληροφορίας και των Επικοινωνιών (ΤΠΕ) στη Μάθηση','ΥΣ15','Γόγουλου','Προαιρετικό',6,),
]
const CoursesDec=()=>{
